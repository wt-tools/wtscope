...
func main() {
	...
	for {
		...
		if ev.Damage != nil {
			...
			log.Log("damage", ev.Origin, "player tank", ev.Damage.Vehicle.Type, "opponent tank", ev.Damage.TargetVehicle.Type, "player", ev.Damage.Player.Name, "target player", ev.Damage.TargetPlayer.Name)
			//}
		}
	}
}
